 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://WS.hicham.net/", wsdlLocation = "http://localhost:8787/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://WS.hicham.net/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://WS.hicham.net/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WS.hicham.net/", "BanqueServicePort"), BanqueService.class, features);
    }
